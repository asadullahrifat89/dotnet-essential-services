...
namespace EmailCore.Implementations.Commands.Validators
{
    public class UpdateTemplateCommandValidator : AbstractValidator<UpdateTemplateCommand>
    {
        ...
        public UpdateTemplateCommandValidator(IEmailRepository emailRepository)
        {
            ...
            RuleFor(x => x.TemplateId).MustAsync(BeAnExistingTemplate).WithMessage("Template doesn't exist.").When(x => !x.TemplateId.Equals(""));
        ...
        {
            return await _emailRepository.BeAnExistingTemplate(templateId);
        }
    }
}
