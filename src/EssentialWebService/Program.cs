...
builder.Services.AddMediatR(cfg => cfg.RegisterServicesFromAssemblies(typeof(AddSearchCriteriaCommand).GetTypeInfo().Assembly));
...
builder.Services.AddValidators<AddSearchCriteriaCommandValidator>();
